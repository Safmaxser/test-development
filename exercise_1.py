def unique_teacher_names(mentors):
    all_list = []
    for m in mentors:
        all_list.extend(m)
    all_names_list = []
...
if __name__ == '__main__':
    ...
    result = unique_teacher_names(mentors_m)
    print(f'Уникальные имена преподавателей: {", ".join(sorted(result))}')